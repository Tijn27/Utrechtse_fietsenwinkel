            ...
            <div class='row' style='background-color: white;'>
                <div class='col'><br>
                     ...
                     if((!$row["accuPositie"] == NULL || !$row["oplaatTijd"] == NULL) || !$row["capaciteitAccu"] == NULL){
                        ...
                        if(!$row["accuPositie"] == NULL){echo"<div class='row' id='border'><a class='col'>Accupositie: </a><a class='col'>" . $row["accuPositie"] . "</a></div>";}
                        if(!$row["oplaatTijd"] == NULL){echo"<div class='row' id='border'><a class='col'>Oplaadtijd: </a><a class='col'>" . $row["oplaatTijd"] . "</a></div>";}
                        if(!$row["capaciteitAccu"] == NULL){echo"<div class='row' id='border'><a class='col'>Capaciteit van de accu: </a><a class='col'>" . $row["capaciteitAccu"] . "Wh</a></div>";}
                     }
                echo"</div>
            </div>
              ";
