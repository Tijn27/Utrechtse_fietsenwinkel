...
if ($result){
    $to = $email;
    $subject = "Activatielink http://www.Allfit1.nl";
    $message = '<!DOCTYPE html>
    <html>
    <body>
    <h1>Beste klant,<h1>
    <p>Bedankt voor het registreren, door op onderstaande link te klikken wordt het registratieproces voltooid.</p> <a href="http://www.Allfit1.nl/index.php?content=createpassword&id=' . $id .'&pw=' . $password_hash . '"> Activeer uw account. (Allfit1.nl)</a>
    <a href="http://p4.nl/index.php?content=createpassword&id=' . $id .'&pw=' . $password_hash . '"> Activeer uw account. (p4.nl)</a>
