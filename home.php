...
<!-- carousel -->
<div style="margin-top: 20px; margin-left:17.5px;" class="bd-example">
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" style=" width:1075px;">
